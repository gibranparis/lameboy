...
/** --- COOL SUN: sun dogs + 22° halo (all inline, no external assets) --- */
  ...
  return (
    ...
    >
      <defs>
        ...
        {/* halo stroke (slight iridescence hint without heavy filters) */}
...
export default function ThemeToggle({ className = '' }) {
  ...
  function applyTheme(next) {
    ...
    // Tailwind's dark-mode strategy should be 'class'
    root.classList.toggle('dark', next === 'night');
    root.dataset.theme = next; // optional hook for your CSS
  ...
  return (
    ...
    >
      ...
      >
        {/* icons crossfade to prevent “white dot” issue */}
        <span
          className={clsx(
